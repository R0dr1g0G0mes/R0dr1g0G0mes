...
* **Tech Stack:** SQL Server Express, SSMS, T-SQL, Data Modeling (Star Schema), ETL, Git.
...
* **Tech Stack:** Databricks, Delta Lake, Apache Spark, PySpark, Lakehouse Architecture, Databricks Workflows.
